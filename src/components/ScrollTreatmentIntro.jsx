    ...
    return (
        <section id="scroll-treatment" className="treatment-section">
            ...
            <div className={`treatment-block back ${isBackActive ? 'active' : ''}`} ref={backRef}>
                <img src={`${import.meta.env.BASE_URL}images/spa-scroll-1.jpg`} alt="Back treatment" className="treatment-bg" />
                <div className="treatment-dot" style={{ top: '60%', left: '50%' }}></div>
                <svg className="connection-line">
                    <line x1="50%" y1="60%" x2="67.2%" y2="50%" className={isBackActive ? 'animate' : ''} />
                </svg>
                <div className="treatment-info">
                    <h3>嚴選SPA療程</h3>
                    <p>以專業細膩的護膚技藝，為肌膚帶來由內而外的深層潔淨與修護。<br />
                        從清除毛孔雜質、平衡肌理，到針對紋理的溫和修復，每一步皆是對肌膚的呵護與傾聽。
                        這不只是一場護理，更是一段專屬於肌膚與時間的溫柔對話，重拾明亮與光采，展現自然細緻的恆久之美。
                    </p>
                </div>
            </div>
            ...
            <div className={`treatment-block face ${isFaceActive ? 'active' : ''}`} ref={faceRef}>
                <img src={`${import.meta.env.BASE_URL}images/spa-scroll-2.jpg`} alt="Face treatment" className="treatment-bg" />
                <div className="treatment-dot" style={{ top: '55%', left: '56%' }}></div>
                <svg className="connection-line">
                    <line x1="56%" y1="55%" x2="72.2%" y2="35%" className={isFaceActive ? 'animate' : ''} />
                </svg>
                <div className="treatment-info">
                    <h3>肌膚管理療程</h3>
                    <p>在溫潤的手技與沉靜氛圍中，釋放日積月累的壓力與疲憊，讓緊繃的身心鬆開。<br />
                        每一道按摩手法皆精心設計，循著身體脈絡流轉，不僅活絡循環、調理氣息，更引領心靈進入到更深層的靜謐。<br />
