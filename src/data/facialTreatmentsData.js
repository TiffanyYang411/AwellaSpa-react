    ...
    treatments: [
      {
        ...
        benefits: ["清除粉刺", "毛孔緊緻"],
        image:`${import.meta.env.BASE_URL}images/facial1.jpg`
      },
      {
        name: "抗痘煥膚療程",
        time: "70 mins",
        ...
        benefits: ["鎮靜抗痘", "平衡油脂"],
        image:`${import.meta.env.BASE_URL}images/facial2.jpg`
      },
      {
        name: "溫和去角質療程",
        time: "60 mins",
        ...
        benefits: ["改善粗糙", "提升光澤"],
        image:`${import.meta.env.BASE_URL}images/facial3.jpg`
      }
    ]
  },
  {
    ...
    treatments: [
      {
        ...
        benefits: ["補水保濕", "肌膚透亮"],
        image:`${import.meta.env.BASE_URL}images/facial4.jpg`
      },
      {
        name: "舒敏修復護理",
        time: "70 mins",
        ...
        image:`${import.meta.env.BASE_URL}images/facial5.jpg`
      },
      {
        name: "玻尿酸精華導入",
        time: "60 mins",
        ...
        benefits: ["強效補水", "修護肌底"],
        image:`${import.meta.env.BASE_URL}images/facial6.jpg`
      }
    ]
  },
  {
    ...
    treatments: [
      {
        ...
        benefits: ["緊緻肌膚", "增加彈性"],
        image:`${import.meta.env.BASE_URL}images/facial7.jpg`
      },
      {
        name: "金箔賦活療程",
        time: "80 mins",
        ...
        benefits: ["活化膚質", "提亮膚色"],
        image:`${import.meta.env.BASE_URL}images/facial8.jpg`
      },
      {
        name: "音波肌能拉提",
        time: "90 mins",
        ...
        image:`${import.meta.env.BASE_URL}images/facial9.jpg`
      }
    ]
  },
  {
    ...
    treatments: [
      {
        ...
        benefits: ["提亮", "改善暗沉"],
        image:`${import.meta.env.BASE_URL}images/facial10.jpg`
      },
      {
        name: "珍珠淨白光感護理",
        time: "75 mins",
        ...
        benefits: ["均勻膚色", "白皙透亮"],
        image:`${import.meta.env.BASE_URL}images/facial11.jpg`
      },
      {
        name: "酵素光亮療程",
        time: "60 mins",
        ...
        benefits: ["平滑膚質", "提亮膚色"],
        image:`${import.meta.env.BASE_URL}images/facial12.jpg`
      }
    ]
  },
  {
    ...
    treatments: [
      {
        ...
        benefits: ["抗老", "緊緻毛孔"],
        image:`${import.meta.env.BASE_URL}images/facial13.jpg`
      },
      {
        name: "晚香御齡護理",
        time: "85 mins",
        ...
        image:`${import.meta.env.BASE_URL}images/facial14.jpg`
      },
      {
        name: "紫晶能量抗老儀式",
        time: "90 mins",
        ...
        benefits: ["活化肌膚", "舒緩壓力"],
        image:`${import.meta.env.BASE_URL}images/facial15.jpg`
      }
    ]
  }
];
